#ifndef EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_SYNC_SEND_MSG_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_SYNC_SEND_MSG_CONTEXT_H_
...
class PageRankSyncSendMsgContext : public ContextBase<FRAG_T> {
 public:
  ...
  void Init(const FRAG_T& frag, DefaultMessageManager& messages,
    ...
    delta.Init(inner_vertices, 0);
    delta_next.Init(inner_vertices, 0);
...
#endif  // EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_SYNC_SEND_MSG_CONTEXT_H_
